...
<section class="event-area-two ptb-100">
	<div class="container">
		...
		<div class="row align-items-center">
				...
				<div class="row">
					<div class="col-lg-12 col-sm-6">
						<div class="single-event">
							<a href="#">
								<img src="{{url('/img/event-img/event-img-1.png')}}" alt="Image">
							</a>
					...
					<div class="col-lg-12 col-sm-6">
						<div class="single-event">
							<a href="#">
								<img src="{{url('/img/event-img/event-img-2.png')}}" alt="Image">
							</a>
							<div class="event-content">
								<ul>
									<li>
					...
					<div class="col-lg-12 col-sm-6 offset-sm-3 offset-lg-0">
						<div class="single-event">
							<a href="#">
								<img src="{{url('/img/event-img/event-img-3.png')}}" alt="Image">
							</a>
							<div class="event-content">
								<ul>
									<li>
			...
			<div class="col-lg-6">
				<div class="event-img">
					<img src="{{url('/img/event-img/event-img-5.png')}}" alt="Image">
					...
					<div class="event-shape-1 rotated">
						<img src="{{url('/img/event-img/event-shape-1.png')}}" alt="Image">
					</div>
					<div class="event-shape-2">
						<img src="{{url('/img/event-img/event-shape-2.png')}}" alt="Image">
					</div>
				</div>
			</div>
		</div>
